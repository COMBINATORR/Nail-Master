...
/**
 * Animated hamburger → X (Skiper99).
 * Controlled via `open` when used as app menu toggle.
 */
export const AnimatedMenuIcon = ({
  ...
  return (
    ...
    >
      <div
        className={cn(
          "relative grid cursor-pointer items-center justify-center",
          sizeClassName
        )}
      >
        <motion.div
  ...
  return (
    <div
      ...
      <div className="relative grid cursor-pointer items-center justify-center">
        ...
        <div
          className="absolute right-[9px] h-[2px] w-3 origin-right scale-x-0 rounded-[1px] bg-current transition-all duration-300 ease-out group-hover:right-[7px] group-hover:scale-x-100"></div>
      </div>
    </div>
  );
};
